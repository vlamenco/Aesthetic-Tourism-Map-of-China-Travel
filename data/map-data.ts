...
export const AESTHETIC_MAP_DATA: MapLocation[] = [
  {
    ...
    items: [
      {type: 'image',
        name: { zh: 'A1.万岁山大宋武侠城', en: 'A1.Wansui Mountain (The Song Dynasty Of Kungfu City万岁山)' },
  ...
  description: {zh: `“铁塔只搭繁塔腰”。so，繁塔才是重点（读Pó，但每次打字都要别扭地“读错”）。
    ...
    en: `The Iron Pagoda 繁Pó塔 only reaches the waist of the Po Tower. So the Po Tower is the real highlight. Shaped like an imperial jade seal, this hexagonal pagoda stands merely three stories tall. Even in its incomplete state, it remains breathtakingly beautiful, situated outside the ancient city wall. 
  ...
  description: {
    ...
    The Iron Pagoda 铁塔 was originally a wooden structure built in 982 to enshrine the Buddha's relics tributated by King Qian Hongchu of Wuyue. It was later burned down by lightning. Reconstructed in 1049 during the reign of Emperor Renzong of the Northern Song Dynasty, it was built with brown glazed bricks.
...
(I may not be broad-minded, but I strongly disagree with this!).`}},
  ...
  description: { zh: `开封唯一留存的元代古建筑群，国内唯一汉+蒙融合的道教建筑。
    ...
    en: `The only surviving ancient architectural complex of the Yuan Dynasty in Kaifeng 延庆观, and the sole Taoist architecture in China blending Han汉 and Mongolian蒙 styles.
...
The following year (712), recalling his decades-long experience ascending the throne as a regional prince相王, Emperor Ruizong issued an imperial edict to rename the newly built Jianguo Temple in Bianliang（Kaifeng） as Daxiangguo Temple 大相国寺and personally inscribed the temple plaque.
...
·The Octagonal Glazed Hall houses a statue of the Thousand-Handed and Thousand-Eyed Guanyin carved from an entire ginkgo tree, which presents a stunning sight and draws an endless stream of worshippers.`}},
  ...
  description: { zh: `建于清乾隆三十一年（1766 年），原址是明代开国功臣徐达府邸，既是三省同乡商会议事场所，也供奉关公，主打 “忠义经商” 理念，号称北方第一会馆。
    ...
    en: `Constructed in the Qianlong reign of the Qing Dynasty (1766), the site 山陕甘会馆 was originally the mansion of Xu Da, a meritorious founding minister of the Ming Dynasty. 
...
Bao Zheng 包公 passed the Jinshi examination at the age of 28, an achievement for someone so young to succeed in the imperial exams. However, he resigned from his official post to return home and care for his elderly parents.
...
(No need to visit the Lord Bao Memorial Temple. All the buildings were reconstructed in recent years.)`}},
    ...
    {type: 'text',
        ...
        value: { zh: `汴绣，也称'宋绣'，为中国十大名绣之一。《东京梦华录》记载，其专为赵宋王公与达官贵人绣制官服及装饰品，也被誉为“官绣”。
          ...
          不过我更喜欢广绣，色彩再靓丽点~`,
          en: ` 汴绣 Also known as Song Embroidery, ranks among China’s Top Ten Famous Embroideries.
    ...
    {type: 'text',
       ...
       links: [{text: '来开封看菊花吧！', url: 'https://www.bilibili.com/video/BV1tq4y1G7rg/?spm_id_from=333.337.search-card.all.click&vd_source=2ce4bbe44dc7454a15293090b00b4edc'}]},   
        ...
        {type: 'text',
        name: { zh: 'D4.北宋官瓷茶具', en: 'D4.Official Porcelain Tea Sets 北宋官瓷' },
        value: { zh: ` g！`,
          en: ` h!`},
